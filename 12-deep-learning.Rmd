...
```{r AE, echo = F, fig.cap = 'Example of an autoencoder', fig.align = 'center', fig.show='hold', out.width = '50%'}
knitr::include_graphics(c("images/AE.png"))
```

```{r AE2, echo = F, fig.cap = 'Example of an autoencoder ', fig.align = 'center', fig.show='hold', out.width = '50%'}
